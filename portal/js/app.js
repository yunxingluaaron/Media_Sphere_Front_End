    ...
    */
    ...
    getDateBeforeNow: function(stringTime) {
        ...
        if(time < 0) {
            ...
            result = parseInt(time/month) + "month(s) ago";
        }else if(time/week >= 1){
            result = parseInt(time/week) + "week(s) ago";
        }else if(time/day >= 1){
            result = parseInt(time/day) + "day(s) ago";
        }else if(time/hour >= 1){
            result = parseInt(time/hour) + "hour(s) ago";
        }else if(time/minute >= 1){
            result = parseInt(time/minute) + "minute(s) ago";
        }else {
            result = "just now";
        }
        return result;
