window.app = {
    ...
    /*
    portalIndexUrl: "http://localhost:8080/news-portal/portal/index.html",           // 门户首页地址
    writerIndexUrl: "http://localhost:8080/news-portal/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://localhost:8080/news-portal/writer/accountInfo.html",     // 用户信息完善页面
    userServerUrl: "http://192.168.1.5:8003",   // 用户服务后端接口地址
    */

    portalIndexUrl: "http://www.inews.com:9090/news-portal/portal/index.html",           // 门户首页地址
    writerLoginUrl: "http://writer.inews.com:9090/news-portal/writer/passport.html",      // 登录页面
    writerIndexUrl: "http://writer.inews.com:9090/news-portal/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://writer.inews.com:9090/news-portal/writer/accountInfo.html",     // 用户信息完善页面

    adminCenterUrl: "http://admin.inews.com:9090/news-portal/admin/contentReview.html",     // 运营管理平台主页
    adminLoginUrl: "http://admin.inews.com:9090/news-portal/admin/login.html",        // admin后台登录页面
    adminIndexUrl: "http://admin.inews.com:9090/news-portal/admin/userList.html",        // admin后台默认页面

    // userServerUrl: "http://user.inews.com:8003",        // 用户服务后端接口地址
    // fsServerUrl: "http://files.inews.com:8004",         // 文件服务后端接口地址
    // adminServerUrl: "http://admin.inews.com:8005",      // 运营管理服务后端接口地址
    // articleServerUrl: "http://article.inews.com:8001",      // 文章服务后端接口地址

    /* 结合 springcloud 使用zuul的网关地址请求即可 */
    userServerUrl: "http://www.inews.com:7070/api/service-user/",        // 用户服务后端接口地址
    fsServerUrl: "http://www.inews.com:7070/api/service-files/",         // 文件服务后端接口地址
    adminServerUrl: "http://www.inews.com:7070/api/service-admin/",      // 运营管理服务后端接口地址
    articleServerUrl: "http://www.inews.com:7070/api/service-article/",      // 文章服务后端接口地址
                ...
                axios.post(
                    ...
                    .then(res => {
                        ...
                        if (res.data.status == 200) {
                            ...
                            // 如果是被冻结状态，则退出登录
                            if (activeStatus == 2) {
                                alert("Your account has been paused. Please contact the admin...");
                                // me.logout(pageVue);
                                return false;
                            }
                            // 保存到session storage
